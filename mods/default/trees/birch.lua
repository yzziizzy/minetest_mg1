...
for i = 1,3 do
	default.register_node_seasons("default:birch_leaves_"..i, {
		...
		groups = {snappy = 3, leaf_rot = 1, flammable = 2, birch_leaves = 1, leaves = 1, handed = 1},
	...
	minetest.register_node("default:birch_fallen_leaves_"..i, {
		...
		paramtype = "light",
		is_ground_content = false,
		groups = {snappy = 3, leaf_rot = 1, flammable = 2, birch_leaves = 1, leaves = 1, fallen_leaves = 1, handed = 1},
		sounds = default.node_sound_leaves_defaults(),
	})
end
